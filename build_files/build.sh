...
# dnf install dosfstools grub2 grub2-efi grub2-tools grub2-tools-extra shim xorriso grub2-efi-x64 grub2-efi-x64-cdboot grub2-efi-x64-modules dracut-live fuse-overlayfs livesys-scripts squashfs-tools -y
